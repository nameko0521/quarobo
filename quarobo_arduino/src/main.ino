...
void loop(){
    FRS_sv.writeMicroseconds(FRS_angle);  FLS_sv.writeMicroseconds(FLS_angle);
    FRL_sv.writeMicroseconds(FRL_angle);  FLL_sv.writeMicroseconds(FLL_angle);
    FRF_sv.writeMicroseconds(FRF_angle);  FLF_sv.writeMicroseconds(FLF_angle);

    RRS_sv.writeMicroseconds(RRS_angle);  RLS_sv.writeMicroseconds(RLS_angle);
    RRL_sv.writeMicroseconds(RRL_angle);  RLL_sv.writeMicroseconds(RLL_angle);
    RRF_sv.writeMicroseconds(RRF_angle);  RLF_sv.writeMicroseconds(RLF_angle);
